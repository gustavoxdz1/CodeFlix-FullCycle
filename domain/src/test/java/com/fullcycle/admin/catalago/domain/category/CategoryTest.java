...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthLessThan3_whenCallNewCategoryAndValidate_thenShouldReciveError() {
        ...
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 char";
        final var expectedDescription = "A Categoria mais assistida";
        final var expectedIsActive = true;
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReciveError() {
        final var expectedName = "perspectivas multidisciplinares representa uma abertura para a melhoria da lógica predominante nas decisões estratégicas. Com efeito, a análise aprofundada dos indicadores-chave desafia a capacidade de equalização dos critérios de excelência amplamente aceitos.\n";
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 char";
        final var expectedDescription = "A Categoria mais assistida";
        final var expectedIsActive = true;
    ...
    public void givenAValidInactiveCategory_whenCallActivate_thenReturnCategoryActivated() {
        ...
        public void givenAValidCategory_whenCallUpdate_thenReturnCategoryUpdate() {
            ...
            final var actualCategory = aCategory.update(expectedDescription, expectedName, expectedIsActive);
        ...
        @Test
         public void givenAValidCategory_whenCallUpdateWhitInvalidParams_thenReturnCategoryUpdate() {
            final String expectedName = null;
            final var expectedDescription = "A categoria mais assistida";
            final var expectedIsActive = true;
